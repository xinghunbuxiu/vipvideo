(function () {
	...
	with (p.encodeFloat = function (t, e, i) {
		...
		r,
		o,
		s = ((s = new this.Buffer(this.bigEndian, t)).checkBuffer(e + i + 1), s),
		a = Math.pow(2, i - 1) - 1,
		l = s.readBits(e + i, 1),
		c = s.readBits(e, i),
		u = 0,
	...
	base64 = function () {
		...
		function e(e) {
			...
			for (e.charAt(s - 1) === r && (o = 1, e.charAt(s - 2) === r && (o = 2), s -= 4), i = 0; s > i; i += 4) {
				n = t(e, i) << 18 | t(e, i + 1) << 12 | t(e, i + 2) << 6 | t(e, i + 3),
							...
							if (i == l.TYPE_DOUBLE) {
								...
								if (i == l.TYPE_FLOAT) {
									...
									if (i == l.TYPE_STRING) {
										...
										i == l.TYPE_NULL ? (o = null, r++) : i == l.TYPE_BOOL ? (o = 0 === n.charCodeAt(r) ? !1 : !0, r++) : i == l.TYPE_REAL16 ? (o = s.toShort(n.substr(r, 2)), o /= 100, r += 2) : i == l.TYPE_REAL24 ? (o = s.toInt(n.substr(r, 3) + "\0"), o /= 1000, r += 3) : i == l.TYPE_REAL32 ? (o = s.toInt(n.substr(r, 4)), o /= 10000, r += 4) : console.log("error: unsupported type:" + i.charCodeAt(0))
									}
								}
							}
						}
