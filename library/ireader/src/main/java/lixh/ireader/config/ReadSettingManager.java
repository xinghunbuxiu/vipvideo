...
public class ReadSettingManager {
    ...
    private SharedPreferencesUtil sharedPreUtils;
    ...
    private ReadSettingManager() {
        sharedPreUtils = SharedPreferencesUtil.getInstance();
    }
    ...
    public int getTextSize() {
        return sharedPreUtils.getInt(SHARED_READ_TEXT_SIZE, DensityUtil.sp2px(28));
    }
