...
public class Constant {
    ...
    public static String BOOK_CACHE_PATH = UFile.getCacheDir() + File.separator
            + "book_cache" + File.separator;
    //文件阅读记录保存的路径
    public static String BOOK_RECORD_PATH = UFile.getCacheDir() + File.separator
